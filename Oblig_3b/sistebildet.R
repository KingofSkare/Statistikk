...
plot(x_plot,yMu,type="l",col="blue") 
abline(v=my_1,col="red")
yXplus = dt.scaled(x_plot,v_1,my_1,splus1) # sannsynlighets fordeling til X_plus
lines(x_plot,yXplus,type="l",col="green")
...
# Plot CDF
plot(x_values, CDF_m, type = "l",col="blue")
lines(x_values, CDF_x, type = "l",col="red")
C_m <- abs(2 * CDF_m - 1)
c_x <- abs(2 * CDF_x - 1)
plot(x_plot, C_m, type = "l",col='blue') #konfidens
lines(x_plot, c_x, type='l',col='red')
lines(x_plot,k_40,type='l',col='green',lty=2) 
lines(x_plot,k_80,type='l',col='green',lty=2) 
lines(x_plot,k_90,type='l',col='green',lty=2) 
